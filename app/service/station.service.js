(function(){
    ...
    app.service('StationService', function ($http, $window, LocationService) {
        'ngInject';
        ...
        function getNextTrains(reqDrivePlan) {
            console.log('reqDrivePlan: ', reqDrivePlan);
            if (reqDrivePlan.destStationId && reqDrivePlan.originStationId) {
                return new Promise(function (resolve, reject) {
                    var urlApi = $window.location.origin + '/api/nextTrain';
